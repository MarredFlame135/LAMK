...
export function HeroSection() {
  return (
    <section className="relative py-20 px-4 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center overflow-hidden">
      ...
      {/* Tarjeta Visual de TENISIN — cristal + iluminación holográfica en hover */}
      <motion.div
        initial={{ opacity: 0, scale: 0.92 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: 0.6, delay: 0.2 }}
        whileHover={{ y: -4, boxShadow: '0 30px 60px -20px rgba(230,0,38,0.35)' }}
        className="lg:col-span-5 bg-gradient-to-b from-[#121215]/90 to-black/90 backdrop-blur-md border border-zinc-800 p-8 rounded-3xl relative overflow-hidden text-center space-y-4 shadow-2xl"
      >
