            ...
            <header className="sticky top-0 z-40 bg-[#0A0A0C]/90 backdrop-blur-md border-b border-zinc-800/80">
              <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
                ...
                <nav className="hidden md:flex items-center gap-6 text-xs font-bold tracking-widest uppercase text-zinc-300">
                  ...
                  <a href="/catalog" className="text-zinc-400 hover:text-white transition">CATÁLOGO</a>
                  <a href="/vault" className="text-zinc-400 hover:text-white transition">BÓVEDA</a>
                  <a href="/admin/offline-sales" className="text-zinc-400 hover:text-white transition">ADMIN</a>
                  <HeaderAuthLink />
                </nav>
